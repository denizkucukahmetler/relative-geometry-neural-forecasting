...
MODELS   = ["mlp", "oldrnn", "transformer", "rnnautoreg", "koopmanmlp",
    "koopmantransformer", "koopmanrnnautoreg",
    "nodetransformer", "nodernnautoreg", "nodemlp","none"
]
DATASETS =["double_pendulum","lorenz","spiral", "logistic_map","pod","hopf","random_skew"] #[ "spiral","pod","hopf","random_skew","double_pendulum","logistic_map","lorenz"]  # edit as needed
SEEDS    = range(1,2)
TAG      = "bests"
